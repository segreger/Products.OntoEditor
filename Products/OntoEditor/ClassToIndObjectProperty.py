...
schema = Schema((
    ...
    ReferenceField(
        ...
        allowed_types=('OntoIndividual'),
        multiValued=0,
        relationship='classtoind_object_range',
    ),
    ReferenceField(
        name='objectProperty',
        widget=ReferenceBrowserWidget(
        ...
        multiValued=0,
        relationship='clastoind_object_property',
    ),
...
ClassToIndObjectProperty_schema = BaseSchema.copy() + \
    schema.copy()

##code-section after-schema #fill in your manual code here
##/code-section after-schema

class ClassToIndObjectProperty(BaseContent, BrowserDefaultMixin):
    """
    """
    security = ClassSecurityInfo()

    implements(interfaces.IClassToIndObjectProperty)

    meta_type = 'ClassToIndObjectProperty'
    _at_rename_after_creation = True

    schema = ClassToIndObjectProperty_schema
...
registerType(ClassToIndObjectProperty, PROJECTNAME)
